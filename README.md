...
[The Kafka Producer](https://github.com/nadinelabidi/Ehealth-Kafka-Project/blob/main/Demo/demoproducer.gif) fakes a Gateway simulator to push data into the topics ` in `JSON` format every five seconds.
